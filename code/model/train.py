...
model = YOLO("models/auklab_model_nano_combined_1394_v1.pt")

# Train the model on the dataset for 30 epochs
...
# Save the model
model.save('models/auklab_model_nano_combined_1394_v2.pt')
